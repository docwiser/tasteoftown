...
<template>
  <div class="admin-coupons">
    <div class="admin-container">
      ...
      <div class="admin-nav">
        <router-link to="/admin" class="admin-nav-link">Dashboard</router-link>
        ...
        <router-link to="/admin/coupons" class="admin-nav-link active">Coupons</router-link>
        ...
        <div v-else class="coupons-grid">
          <div v-for="coupon in coupons" :key="coupon.id" class="coupon-card">
            <div class="coupon-header">
              ...
              <span
                class="coupon-status"
                :class="{ active: coupon.active, inactive: !coupon.active }"
              >
