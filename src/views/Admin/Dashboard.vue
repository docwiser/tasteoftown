...
<template>
  <div class="admin-dashboard">
    <div class="admin-container">
      ...
      <div class="admin-nav">
        <router-link to="/admin" class="admin-nav-link active">Dashboard</router-link>
        <router-link to="/admin/menu" class="admin-nav-link">Menu</router-link>
        <router-link to="/admin/orders" class="admin-nav-link">Orders</router-link>
        <router-link to="/admin/coupons" class="admin-nav-link">Coupons</router-link>
        <router-link to="/admin/users" class="admin-nav-link">Users</router-link>
      </div>
      ...
      <div v-else>
        ...
        <div v-if="pendingApprovalOrders.length > 0" class="alert-section">
          ...
          <router-link to="/admin/orders" class="btn-primary">View Orders</router-link>
        </div>
            ...
            <table>
              ...
              <tbody>
                <tr v-for="order in todayOrders.slice(0, 10)" :key="order.id">
                  ...
                  <td>
                    <router-link :to="`/admin/orders`" class="btn-view">
                      View
                    </router-link>
                  </td>
                </tr>
